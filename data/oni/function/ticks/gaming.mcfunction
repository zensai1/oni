...
##異能
    ...
    ##隠遁
        ...
        execute as @a[tag=Restraint,scores={Znsi.Ability=1},predicate=oni:effect/invisibility] run effect clear @s invisibility
    ...
    ##変装
        ...
        execute as @a[tag=Restraint,scores={Znsi.Ability=3},predicate=oni:effect/luck] run effect clear @s luck

    ##探知
        execute as @a[scores={Znsi.Use.Carrotstick=1}] at @s if score @s Znsi.Ability matches 4 run function oni:ability/detection/
        execute as @a[scores={Znsi.Ability=4}] at @s if items entity @s weapon.mainhand carrot_on_a_stick positioned ~ ~1 ~ run function oni:ability/detection/particle
    ...
    ##偵察
        ...
        execute as @a[tag=Reconnaissance,tag=Restraint] at @s run function oni:ability/reconnaissance/reconnaissance_04

    ##抑制
        execute as @a[scores={Znsi.Use.Carrotstick=1}] at @s if score @s Znsi.Ability matches 6 run function oni:ability/restraint/
        execute as @a[scores={Znsi.Ability=6}] at @s if items entity @s weapon.mainhand carrot_on_a_stick positioned ~ ~1 ~ run function oni:ability/restraint/particle
        execute as @a[tag=Restraint] at @s run particle dust{color:[0.000,0.000,0.000],scale:1.5} ~ ~3 ~ 0 0 0 1 10 force
        execute as @a[tag=Restraint] run scoreboard players add @s Znsi.RestraintTime 1
        execute as @a[tag=Restraint,scores={Znsi.RestraintTime=200..}] at @s run function oni:ability/restraint/cancellation

    ##吸引
        execute as @a[scores={Znsi.Use.Carrotstick=1}] at @s if score @s Znsi.Ability matches 7 run function oni:ability/suction/
        execute as @a[scores={Znsi.Ability=7}] at @s if items entity @s weapon.mainhand carrot_on_a_stick positioned ~ ~1 ~ run function oni:ability/suction/particle
    ...
    ##飛躍
        ...
        execute as @a[tag=Restraint,tag=Pre_Leap] at @s run function oni:ability/leap/cancel
    ...
    ##音爆 
        ...
        execute as @a[scores={Znsi.Ability=10}] at @s if items entity @s weapon.mainhand carrot_on_a_stick positioned ~ ~1 ~ run function oni:ability/sound_explosion/particle
        execute as @a[tag=Sound_Explosion] run scoreboard players add @s Znsi.SoundTime 1
        execute as @a[scores={Znsi.SoundTime=40}] at @s positioned ~ ~ ~ run function oni:ability/sound_explosion/sound
        execute as @a[scores={Znsi.SoundTime=80}] at @s positioned ~ ~ ~ run function oni:ability/sound_explosion/sound
        execute as @a[scores={Znsi.SoundTime=120}] at @s positioned ~ ~ ~ run function oni:ability/sound_explosion/sound
        execute as @a[scores={Znsi.SoundTime=160}] at @s positioned ~ ~ ~ run function oni:ability/sound_explosion/sound
        execute as @a[scores={Znsi.SoundTime=200}] at @s positioned ~ ~ ~ run function oni:ability/sound_explosion/sound
        execute as @a[scores={Znsi.SoundTime=200}] run function oni:ability/sound_explosion/cancellation

    ##安寧
        execute as @a[scores={Znsi.Use.Carrotstick=1}] at @s if score @s Znsi.Ability matches 11 run function oni:ability/pom/
        execute as @a[tag=Nige_Pom,predicate=oni:move/sprint] at @s run function oni:ability/pom/cancel
        execute as @a[tag=Nige_Pom,tag=Restraint] at @s run function oni:ability/pom/cancel

    ##蒼穹
        execute as @a[scores={Znsi.Use.Carrotstick=1}] at @s if score @s Znsi.Ability matches 12 run function oni:ability/blue_sky/


##気配
    execute as @a[team=oni] at @s store result score @s Znsi.Sign if entity @a[team=nige,distance=..25]
...
##発光玉
    execute as @a[team=oni] run scoreboard players add @s Znsi.OniTime 1
    execute as @a[team=oni,scores={Znsi.OniTime=1200}] run loot give @s loot oni:luminous_ball
    execute as @a[scores={Znsi.Use.SnowBall=1..}] run function oni:game/glowing
